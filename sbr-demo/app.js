...
onLinkNavigate(async ({ fromPath, toPath }) => {
  ...
  if (navigationType === 'gallery-to-ppl-page') {
    ...
    // targetFirstName = getLink(toPath).querySelector(".firstname");
    // targetFirstName.style.viewTransitionName = 'firstname';
  }
  ...
  const transition = transitionHelper({
    updateDOM() {
      ...
      if (navigationType === 'ppl-page-to-gallery') {
        ...
        targetFirstName = getLink(fromPath).querySelector(".firstname");
        targetFirstName.style.viewTransitionName = 'firstname';
